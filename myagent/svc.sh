...
SVC_NAME=`systemd-escape --path "vsts.agent.ozblech87.myUbuntuAgentPool.oz-Lenovo-IdeaPad-S540-14IML.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (ozblech87.myUbuntuAgentPool.oz-Lenovo-IdeaPad-S540-14IML)"
